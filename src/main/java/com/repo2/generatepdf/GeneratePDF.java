...
public class GeneratePDF {
   ...
   public static final String CLONELOG = System.getProperty("user.dir") + File.separator + "STIW3054-Result" + File.separator + "clone.log";
    ...
    public static final String CLONEPDF = System.getProperty("user.dir") + File.separator + "clone.pdf";
    public static final String COMPILEPDF = System.getProperty("user.dir") + File.separator + "compile.pdf";

    
    public GeneratePDF() throws DocumentException, IOException {
        File file = new File(CLONEPDF);
